<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('role.title') ? 'invalid' : '' }}">
        <label class="form-label required dark:text-light" for="title">{{ trans('cruds.role.fields.title') }}</label>
    ...
    <div class="form-group {{ $errors->has('permissions') ? 'invalid' : '' }}">
        <label class="form-label required dark:text-light" for="permissions">{{ trans('cruds.role.fields.permissions') }}</label>
