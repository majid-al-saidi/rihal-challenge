    ...
    <div class="flex flex-wrap">
        <form wire:submit.prevent="updatePassword" class="w-full">
            <div class="form-group px-4">
                <label class="form-label dark:text-light" for="current_password">{{ __('global.current_password') }}</label>
            ...
            <div class="form-group px-4">
                <label class="form-label dark:text-light" for="new_password">{{ __('global.new_password') }}</label>
            ...
            <div class="form-group px-4">
                <label class="form-label dark:text-light" for="password_confirmation">{{ __('global.confirm_password') }}</label>
