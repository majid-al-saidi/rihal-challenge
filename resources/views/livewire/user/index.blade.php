<div>
    <div class="card-controls sm:flex">
        ...
        <div class="w-full sm:w-1/2">
            Per page:
            <select wire:model="perPage" class="form-select  sm:w-1/6 dark:text-primary">
        ...
        <div class="flex w-full sm:w-1/2 sm:text-right ">
                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'class.class_name'])
                        </th>
                        <th>
